...
use AWSD\Schema\Mapper\SGBD\PostgreSQL\QuoteMapper as PostgreSQLQuoteMapper;
use AWSD\Schema\Mapper\SGBD\MySQL\QuoteMapper as MySQLQuoteMapper;
use AWSD\Schema\Mapper\SGBD\SQLite\QuoteMapper as SQLiteQuoteMapper;
