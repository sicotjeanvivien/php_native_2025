...
use AWSD\Database\Schema\Mapper\SGBD\MySQL\TriggerMapper as MySQLTriggerMapper;
use AWSD\Database\Schema\Mapper\SGBD\PostgreSQL\TriggerMapper as PostgreSQLTriggerMapper;
use AWSD\Database\Schema\Mapper\SGBD\SQLite\TriggerMapper as SQLiteTriggerMapper;
 ...
 * ```
 *
 * @see \AWSD\Database\Schema\Query\TriggerQuery
 */
